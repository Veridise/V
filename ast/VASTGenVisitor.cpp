...
namespace vastgenvisitor {
  VAST* VASTGenVisitor::visitSpec(VParser::SpecContext *ctx) {
  ...
  VImportList *VASTGenVisitor::visitImports(VParser::ImportsContext *ctx) {
  ...
  VBehavioralSpec* VASTGenVisitor::visitBehavioralSpec(VParser::BehavioralSpecContext *ctx) {
  ...
  VTestSpec* VASTGenVisitor::visitTestSpec(VParser::TestSpecContext *ctx) {
    VVarDeclList* var_decs = nullptr;
  ...
  VTempSpec* VASTGenVisitor::visitTempSpec(VParser::TempSpecContext *ctx) {
    VVarDeclList* var_decs = nullptr;
  ...
  VInvSpec* VASTGenVisitor::visitInvariantSpec(VParser::InvariantSpecContext *ctx) {
    VVarDeclList* var_decs = nullptr;
    VImportList *imports = nullptr;
    if (ctx->imports()) {
      imports = visitImports(ctx->imports());
  ...
  VSynthSpec* VASTGenVisitor::visitSynthSpec(VParser::SynthSpecContext *ctx) {
  ...
  VVarDeclList* VASTGenVisitor::visitVarsSection(VParser::VarsSectionContext *ctx) {
    return visitDeclList(ctx->declList());
  }

  VStatementExpr* VASTGenVisitor::visitInitSection(VParser::InitSectionContext *ctx) {
    return visitSeqAtom(ctx->seqAtom());
  }

  VStatementExpr* VASTGenVisitor::visitSpecSection(VParser::SpecSectionContext *ctx) {
    return visitSeqAtom(ctx->seqAtom());
  }

  VStatementExpr* VASTGenVisitor::visitSynthSection(VParser::SynthSectionContext *ctx) {
    return visitAtom(ctx->atom());
  }

  VStatementExpr* VASTGenVisitor::visitLtlFairnessSection(VParser::LtlFairnessSectionContext *ctx) {
    return visitSmartltlAtom(ctx->smartltlAtom());
  }

  VStatementExpr* VASTGenVisitor::visitLtlPropertySection(VParser::LtlPropertySectionContext *ctx) {
    return visitSmartltlAtom(ctx->smartltlAtom());
  }

  VStatementExpr* VASTGenVisitor::visitInvariantSection(VParser::InvariantSectionContext *ctx) {
    return visitInvAtom(ctx->invAtom());
  }

  VStatementExpr* VASTGenVisitor::visitInvAtom(VParser::InvAtomContext *ctx) {
    if (ctx->CONTRACT_INV()) {
  ...
  VStatementExpr* VASTGenVisitor::visitSmartltlAtom(VParser::SmartltlAtomContext *ctx) {
    if (ctx->atom()) {
      return visitAtom(ctx->atom());
    }
  ...
  VStatementExpr* VASTGenVisitor::visitSeqAtom(VParser::SeqAtomContext *ctx) {
  ...
  VVarDeclList* VASTGenVisitor::visitDeclList(VParser::DeclListContext *ctx) {
  ...
  VType* VASTGenVisitor::visitTyp(VParser::TypContext *ctx) {
  ...
  VID* VASTGenVisitor::visitIdent(VParser::IdentContext *ctx) {
    string name;
    if (ctx->IDENTIFIER()) {
  ...
  VStatementExpr* VASTGenVisitor::visitPostcondSection(VParser::PostcondSectionContext *ctx) {
    return visitAtom(ctx->atom());
  }

  VStatementExpr* VASTGenVisitor::visitPrecondSection(VParser::PrecondSectionContext *ctx) {
    return visitAtom(ctx->atom());
  }

  VStatementExpr* VASTGenVisitor::visitAtom(VParser::AtomContext *ctx) {
  ...
  VFunctionID* VASTGenVisitor::visitAtomFn(VParser::AtomFnContext *ctx) {
  ...
  VConstraintExpr* VASTGenVisitor::visitAtomFnName(VParser::AtomFnNameContext *ctx) {
    VID *field;
    if(ctx->WILDCARD()) {
  ...
  VArgList* VASTGenVisitor::visitParams(VParser::ParamsContext *ctx) {
  ...
  VConstraintExpr* VASTGenVisitor::visitConstraint(VParser::ConstraintContext *ctx) {
    if (ctx->constraint().size() > 0) {
  ...
  VConstraintExpr* VASTGenVisitor::visitBoolExpr(VParser::BoolExprContext *ctx) {
    if (ctx->boolExpr()) {
  ...
  VConstraintExpr* VASTGenVisitor::visitVarAccess(VParser::VarAccessContext *ctx) {
    if (ctx->varAccess()) {
      VConstraintExpr *var = visitVarAccess(ctx->varAccess());
      if (ctx->LBRACK()) {
  ...
  VConstraintExpr* VASTGenVisitor::visitFnName(VParser::FnNameContext *ctx) {
    VID *id = visitIdent(ctx->ident());
  ...
  VArgList* VASTGenVisitor::visitArgList(VParser::ArgListContext *ctx) {
    vector<VConstraintExpr*> args;
    if (ctx->arithExpr()) {
  ...
  VConstraintExpr* VASTGenVisitor::visitArithExpr(VParser::ArithExprContext *ctx) {
    if (ctx->varOrNum()) {
      return visitVarOrNum(ctx->varOrNum());
    }
